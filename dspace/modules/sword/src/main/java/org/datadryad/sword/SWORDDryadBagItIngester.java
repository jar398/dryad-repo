...
import org.dspace.sword.DSpaceSWORDErrorCodes;

import org.purl.sword.base.Deposit;
import org.purl.sword.base.SWORDErrorException;

public class SWORDDryadBagItIngester implements SWORDIngester
{
	private SWORDService swordService;

	/** Log4j logger */
	public static final Logger log = Logger.getLogger(SWORDDryadBagItIngester.class);
		...
		throws DSpaceSWORDException, SWORDErrorException
	{
		try
		{
			...
			String cfg = ConfigurationManager.getProperty("sword.dryad-ingester.package-ingester");
			if (cfg == null || "".equals(cfg))
			{
				cfg = "DryadBagIt";  // default to DryadBagIt
			}
			...
			// the licence is either in the zip or the manifest.  Either way
			...
			if (ingestedObject == null)
			{
				...
				throw new SWORDErrorException(DSpaceSWORDErrorCodes.UNPACKAGE_FAIL, "DryadBagIt package ingester failed to unpack package");
			}
